...
nnoremap <Leader>gl :Git log --oneline -n 100 -- %<Left><Left><Left><Left><Left>
nnoremap <Leader>gL :Git log --oneline -n 100
...
nnoremap <Leader>gR :GMove %<Tab>
nnoremap <Leader>gc <Cmd>Git commit --allow-empty<CR>
